...
- [ ] iOS保存問題：ダウンロードがファイル/ドライブに保存される→写真アプリへ確実に保存できる仕様に変更（Web Share API + Blob方式）
- [ ] AI加工品質劣化：FIT WARSのプロンプトを元の高品質設定（被写体の特徴を捉えた全身チビキャラ）に修復
- [ ] AI加工品質劣化：免許メーカーのプロンプトを元の高品質設定（被写体の特徴を捉えた3Dアニメ風）に修復
