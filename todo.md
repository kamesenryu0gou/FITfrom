...
- [x] 緊急修正：gpt-image-1 editモードを廃止しDALL-E 3新規生成モードに変更（APIエラー解消）、テキスト排除・年齢固定（40〜50代男性）・厚塗り品質の凝縮プロンプトを実装
- [x] AI加工仕様を超精巧ファンタジーイラスト変換ロジック（de91fbb6）に戻しつつ、APIエラー解消済みのDALL-E 3新規生成パイプラインを維持する
